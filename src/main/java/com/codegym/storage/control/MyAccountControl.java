...
@WebServlet(name = "MyAccountControl", urlPatterns = {"/save"})
...
//        int sid = a.getUid();
//        DAO dao = new DAO();
//        dao.insertMyAccount(sid, name, age, email, phone, address);
...
//    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        dao.insertMyAccount(name, age, email, phone, address,user_name);
